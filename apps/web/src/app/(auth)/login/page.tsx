    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative z-10">
      ...
      >
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-white/60">Enter VerseCV.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between pl-1">
              ...
              <Link href="#" className="text-xs text-accent hover:text-white transition-colors">Forgot password?</Link>
            </div>
            <div className="relative">
        ...
        <p className="text-center text-sm text-white/50 mt-8">
          ...
          <Link href="/register" className="text-white hover:text-accent transition-colors font-medium">
            Create one
          </Link>
        </p>
      </motion.div>
